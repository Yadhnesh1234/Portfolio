...
const Project = () => {
  ...
  return (
    <div className="w-full text-center">
      <h1 className="text-3xl md:text-4xl lg:text-5xl font-eurostile font-semibold mt-10">
        My Work
      </h1>
      <div className="relative mx-auto mt-6 max-w-lg">
          ...
          {ProjectList.map((val, index) => (
            <div
              ...
              className={`w-full h-1/2 ml-2 mr-2 ${
                index === currentIndex ? "highlight" : "blur"
              }`}
            ...
            >
              ...
              />
              <p className="text-lg md:text-xl lg:text-2xl font-semibold font-eurostile mt-4">
                {val.name}
              </p>
              <p className="text-sm md:text-lg lg:text-xl font-eurostile mt-2">
                {val.desc}
              </p>
            </div>
          ))}
        ...
        <button
          className={`absolute left-0 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-50 border border-purple-500 rounded-lg shadow-md px-2 py-1 ${
        ...
        <button
          className={`absolute right-0 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-50 border border-purple-500 rounded-lg shadow-md px-2 py-1 `}
