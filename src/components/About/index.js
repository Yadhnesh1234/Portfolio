...
const About = ({ isDarkTheme }) => {
  return (
    <div
      className={`${
        isDarkTheme ? 'bg-gray-900 text-white' : 'bg-purple-600 text-white'
    ...
    >
      <div
        className={`flex flex-col justify-center items-center text-base p-20 lg:p-72 text-center ${
          isDarkTheme ? 'text-white' : 'text-black'
        }`}
      >
        <h2
          className={`text-4xl font-bold ${
            isDarkTheme ? 'text-green-500' : 'text-white'
          }`}
        >
        ...
        <div className="mt-4 flex">
          <a
            ...
            className={`text-gray-500 hover:text-gray-700 ${
              isDarkTheme ? '' : 'text-gray-700 opacity-95'
            }`}
          >
            <FaLinkedin size={32} />
          </a>
